...
const objArrLink = [
  { text: 'Link roto muy roto',
    ...
    file:
    `${process.cwd()}\\src\\mds\\ejemplo\\ejemlo.md`},
  { text: 'Markdown',
    href: 'https://es.wikipedia.org/wiki/Markdown',
    file: `${process.cwd()}\\src\\mds\\ejemplo\\ejemlo.md`
  },
  { text: 'Node.js',
...
describe('getTheLinks', () => {
  it('Debería retornar un array de objetos de links', () => {
    const returnLinks = getTheLinks(`${process.cwd()}\\src`);
...
describe('validatingLinks', () => {
  it('Debería retornar el objeto con dos propiedades más', () => {
    return validatingLinks(`${process.cwd()}\\src`)
...
describe('mdLinks', () => {
  it('Debería retornar el objeto de los links con dos propiedades más', () => {
    return mdLinks(`${process.cwd()}\\src`, {validate: true})
  ...
  it('Debería retornar el objeto de los links sin las dos propiedades', () => {
    return mdLinks(`${process.cwd()}\\src`, {validate: false})
